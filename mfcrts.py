# MFC Remote FFMPEG TS Anonymous Recorder v.1.0.4 by Horacio for Python 2.7.13
...
if __name__ == "__main__":
        ...
        if vs == 0:
         if server != 0:
                ...
                print
                command = ('ffmpeg -hide_banner -loglevel panic -i {} -c copy -vsync 2 -r 60 -b:v 500k {}'.format(url,fn))
                os.system(command)
                print
                time.sleep(1)    # pause 1 second
                print(colored(" => END <=", "yellow","on_blue"))
