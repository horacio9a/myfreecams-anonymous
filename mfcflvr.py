# MFC Remote FF-FLV Anonymous Recorder v.1.1.0 by horacio9a for Python 2.7.14
...
if __name__ == '__main__':
   ...
   if vs == 0:
      if server != 0:
         ...
         print
         command = '{} -hide_banner -loglevel panic -i {} -c:v copy -map 0:1 -map 0:2 -c:a aac -b:a 160k {}'.format(ffmpeg,hlsurl,pf)
         os.system(command)
         print(colored(" => END <=","yellow","on_blue"))
         sys.exit()
